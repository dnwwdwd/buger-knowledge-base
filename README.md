...
**🍔堡库** 是基于 **Vue3.5** + **Element-Plus-X** + **hook-fetch** + **TypeScript** + **Eslint9** 开发的企业级AI应用模板，搭配 **Spring Boot** + **Spring AI** + **Elasticsearch** + **Sa-Token** 后端。

## 💡 核心优势
- 最新技术栈：Vue3.5+/Vite6/Pinia3/TypeScript5/Spring AI/Elasticsearch/Sa-Token
...
| 功能模块                | 说明                          | 链接                                                                 |
|---------------------|-------------------------------|----------------------------------------------------------------------|
| 🚀 前端仓库             | Gitee/GitHub 代码仓库(感谢 star🥰爱你爱你😘) | [Gitee](https://gitee.com/he-jiayue/ruoyi-element-ai) <br> [GitHub](https://github.com/dnwwdwd/buger-knowledge-base-frontend) |
| 🛠️ 后端仓库            | Java服务，功能丰富强大      |   [Gitee](https://github.com/dnwwdwd/buger-knowledge-base) <br> [GitHub](https://github.com/ageerle/ruoyi-ai)    |
| 📚 Element Plus X文档 | 开发指南/项目说明              | [快速了解项目](https://chat-docs.element-plus-x.com)       |
